...
tekst = Label(aken, text="Siia kunagi vastus!").grid(row=0, column=0, columnspan=4)
#nupud
nupp1 = Button(aken, text="7", width=4)
nupp1.grid(row=1, column=0, padx=2, pady=2)
nupp2 = Button(aken, text="4", width=4)
nupp2.grid(row=2, column=0, padx=2, pady=2)
nupp3 = Button(aken, text="1", width=4)
nupp3.grid(row=3, column=0, padx=2, pady=2)
nupp4 = Button(aken, text="0", width=4)
nupp4.grid(row=4, column=0, padx=2, pady=2)
nupp5 = Button(aken, text="8", width=4)
